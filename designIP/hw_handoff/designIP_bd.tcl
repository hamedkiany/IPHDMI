...
################################################################
# This is a generated script based on design: designIP
#
...
# source designIP_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# clk_wiz_0, color_bar, rgb2dvi
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set clk_wiz_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clk_wiz_0_0 eq "" } {
  ...
  connect_bd_net -net color_bar_0_rgb_b [get_bd_pins color_bar_0/rgb_b] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net color_bar_0_rgb_g [get_bd_pins color_bar_0/rgb_g] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net color_bar_0_rgb_r [get_bd_pins color_bar_0/rgb_r] [get_bd_pins xlconcat_0/In0]
