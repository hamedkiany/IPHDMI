...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "kClkSwap" -parent ${Page_0}
  ipgui::add_param $IPINST -name "kD0Swap" -parent ${Page_0}
  ipgui::add_param $IPINST -name "kD1Swap" -parent ${Page_0}
  ipgui::add_param $IPINST -name "kD2Swap" -parent ${Page_0}
